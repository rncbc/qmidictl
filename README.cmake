...
1. You need CMake 3.10 or newer to build QmidiCtl

2. Unpack the QmidiCtl sources somewhere, or checkout the repository, 
   and create a build directory. For instance, using a command line shell:
   
$ tar -xvzf Downloads/qmidictl-x.y.z.tar.gz
$ cd qmidictl-x.y.z
$ mkdir build
...
The CMake build system for QmidiCtl is experimental. It will take a while
until it becomes stable and fully tested. You can help providing feedback, 
please send a report containing your problems to the QmidiCtl development 
mailing list, https://lists.sourceforge.net/mailman/listinfo/qmidictl-devel
