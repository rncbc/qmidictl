...
#ifndef __qmidictlMenuStyle_h
#define __qmidictlMenuStyle_h

/* This code is borrowed/adapted from menustyle.h
 *
 * menustyle.h
 *
 ...
 */
class qmidictlMenuStyle : public QProxyStyle
{
public:
	/** Constructor */
	qmidictlMenuStyle(QStyle *style = Q_NULLPTR);
...
#endif	// __qmidictlMenuStyle_h

// end of qmidictlMenuStyle.h
